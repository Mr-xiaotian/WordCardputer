...
| `vocabLabel` | `String` | 当前词库标签（第 0 页显示为"词源"） |
...
| 页码 | 内容 |
|------|------|
| 0 | 词源标签（`vocabLabel`）、总数、平均分、中位数、评价 |
| 1 | 等级 1/2/3 的数量与占比表格 |
| 2 | 等级 4/5 的数量与占比表格 |

- 第 0 页的"词源"行显示 `vocabLabel`（格式如 `Demo_Basics` 或 `Demo_Basics/Unit_1`）。
- 百分比四舍五入到整数。
