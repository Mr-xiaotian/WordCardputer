...
static int _buildSimpleTableLayout(
    M5Canvas &cv,
...
static void _drawSimpleTableHeader(
    M5Canvas &cv,
    const std::vector<String> &headers,
...
static void _drawSimpleTableRows(
    M5Canvas &cv,
    const std::vector<std::vector<String>> &rows,
    const std::vector<int> &colXs,
    const std::vector<int> &colWidths,
...
static int _simpleTableTotalWidth(const std::vector<int> &colWidths);

static void _rebalanceSimpleTableWidths(
    int targetTotal,
...
static String _fitWordTableCellText(
    M5Canvas &cv,
    const String &text,
    int maxWidth);
