...
static bool streamWordListAsJson(const String &source, const String &chapter, const String &downloadName) {
    sqlite3 *db = nullptr;
 ...
 */
static void handleApiFileUpload() {
    sendCorsHeaders();
 ...
 */
static bool deleteOrphanWords(sqlite3 *db) {
 ...
 */
static void handleApiFileDownload() {
    sendCorsHeaders();
    String path = server.arg("path");
    bool isRoot = false;
    String source;
